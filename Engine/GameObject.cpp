...
void GameObject::AddComponent(shared_ptr<Component> component)
{
	...
	// component->SetGameObject(this); 스마트 포인터가 아님
	// component->SetGameObject(make_shared<GameObject>(this)); 새로운 스마트 포인터를 생성하게 되어 별개의 포인터가 됨
	// public enable_shared_from_this<GameObject>을 상속받아 shared_from_this 를 사용하는것이 제일 좋다
	// 별건 아니고 자기 자신에 대한 weak ptr를 들고 있는 클래스를 상속받아 shared_ptr<GameObject>(_wptr) 처럼 사용하는 것이다.
